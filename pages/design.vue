<template>
  <main class="px-3 xxl:container overflow-hidden">
    <Navbar />
    <Hero
      indicator-text="Díjmentes tanácsadás"
      indicator-src="/icons/like-icon.svg"
      indicator-alt="Like Icon"
...
useHead({
  ...
  meta: [
    ...
    { property: "og:image", content: "https://www.whiz.hu/whiz-og-design.png" },
  ],
  link: [
    {
      rel: "icon",
